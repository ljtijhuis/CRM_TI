...
/**
 * Base class that represents a row from the 'vervolgactie' table.
 *
 * 
 *
 * @package    propel.generator.CRM_TI.om
 */
abstract class BaseVervolgactie extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'VervolgactiePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        VervolgactiePeer
	 */
	...
	/**
	 * Initializes internal state of BaseVervolgactie object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Vervolgactie The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = VervolgactiePeer::ID;
		}
	...
	public function setDatum($v)
	{
		...
		if ( $this->datum !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = VervolgactiePeer::DATUM;
			}
	...
	public function setOmschrijving($v)
	{
		...
		if ($this->omschrijving !== $v) {
			$this->omschrijving = $v;
			$this->modifiedColumns[] = VervolgactiePeer::OMSCHRIJVING;
		}
	...
	public function setGebruikerId($v)
	{
		...
		if ($this->gebruiker_id !== $v) {
			$this->gebruiker_id = $v;
			$this->modifiedColumns[] = VervolgactiePeer::GEBRUIKER_ID;
		}
	...
	public function setOrganisatieId($v)
	{
		...
		if ($this->organisatie_id !== $v) {
			...
			$this->modifiedColumns[] = VervolgactiePeer::ORGANISATIE_ID;
		}
	...
	public function setAfgehandeld($v)
	{
		...
		if ($this->afgehandeld !== $v || $this->isNew()) {
			$this->afgehandeld = $v;
			$this->modifiedColumns[] = VervolgactiePeer::AFGEHANDELD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->gebruiker_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->organisatie_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->afgehandeld = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = VervolgactiePeer::NUM_COLUMNS - VervolgactiePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Vervolgactie object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VervolgactiePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				VervolgactiePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(VervolgactiePeer::ID) ) {
					...
					$affectedRows += VervolgactiePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = VervolgactiePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = VervolgactiePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = VervolgactiePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getDatum(),
			$keys[2] => $this->getOmschrijving(),
			$keys[3] => $this->getGebruikerId(),
			$keys[4] => $this->getOrganisatieId(),
			$keys[5] => $this->getAfgehandeld(),
		);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setGebruikerId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setOrganisatieId($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setAfgehandeld($arr[$keys[5]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VervolgactiePeer::ID)) $criteria->add(VervolgactiePeer::ID, $this->id);
		if ($this->isColumnModified(VervolgactiePeer::DATUM)) $criteria->add(VervolgactiePeer::DATUM, $this->datum);
		if ($this->isColumnModified(VervolgactiePeer::OMSCHRIJVING)) $criteria->add(VervolgactiePeer::OMSCHRIJVING, $this->omschrijving);
		if ($this->isColumnModified(VervolgactiePeer::GEBRUIKER_ID)) $criteria->add(VervolgactiePeer::GEBRUIKER_ID, $this->gebruiker_id);
		if ($this->isColumnModified(VervolgactiePeer::ORGANISATIE_ID)) $criteria->add(VervolgactiePeer::ORGANISATIE_ID, $this->organisatie_id);
		if ($this->isColumnModified(VervolgactiePeer::AFGEHANDELD)) $criteria->add(VervolgactiePeer::AFGEHANDELD, $this->afgehandeld);
	...
	{
		$criteria = new Criteria(VervolgactiePeer::DATABASE_NAME);
		$criteria->add(VervolgactiePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Vervolgactie (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Vervolgactie Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     VervolgactiePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new VervolgactiePeer();
		}
		return self::$peer;
	}
	...
	public function getGebruiker(PropelPDO $con = null)
	{
		if ($this->aGebruiker === null && ($this->gebruiker_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aGebruiker->addVervolgacties($this);
			 */
		}
	...
	public function getOrganisatie(PropelPDO $con = null)
	{
		if ($this->aOrganisatie === null && ($this->organisatie_id !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aOrganisatie->addVervolgacties($this);
			 */
		}
