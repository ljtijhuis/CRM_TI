...
abstract class BaseContactPeer {
	...
	const CLASS_DEFAULT = 'CRM_TI.Contact';
	...
	const DATUM = 'contact.DATUM';

	/** the column name for the WIJZE field */
	const WIJZE = 'contact.WIJZE';

	/** the column name for the AANDACHTSPUNTEN field */
	const AANDACHTSPUNTEN = 'contact.AANDACHTSPUNTEN';

	/** the column name for the PERSOON_ID field */
	const PERSOON_ID = 'contact.PERSOON_ID';

	/** the column name for the GEBRUIKER_ID field */
	const GEBRUIKER_ID = 'contact.GEBRUIKER_ID';

	/** the column name for the ORGANISATIE_ID field */
	const ORGANISATIE_ID = 'contact.ORGANISATIE_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Datum', 'Wijze', 'Aandachtspunten', 'PersoonId', 'GebruikerId', 'OrganisatieId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'datum', 'wijze', 'aandachtspunten', 'persoonId', 'gebruikerId', 'organisatieId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATUM, self::WIJZE, self::AANDACHTSPUNTEN, self::PERSOON_ID, self::GEBRUIKER_ID, self::ORGANISATIE_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATUM', 'WIJZE', 'AANDACHTSPUNTEN', 'PERSOON_ID', 'GEBRUIKER_ID', 'ORGANISATIE_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'datum', 'wijze', 'aandachtspunten', 'persoon_id', 'gebruiker_id', 'organisatie_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Datum' => 1, 'Wijze' => 2, 'Aandachtspunten' => 3, 'PersoonId' => 4, 'GebruikerId' => 5, 'OrganisatieId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'datum' => 1, 'wijze' => 2, 'aandachtspunten' => 3, 'persoonId' => 4, 'gebruikerId' => 5, 'organisatieId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATUM => 1, self::WIJZE => 2, self::AANDACHTSPUNTEN => 3, self::PERSOON_ID => 4, self::GEBRUIKER_ID => 5, self::ORGANISATIE_ID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATUM' => 1, 'WIJZE' => 2, 'AANDACHTSPUNTEN' => 3, 'PERSOON_ID' => 4, 'GEBRUIKER_ID' => 5, 'ORGANISATIE_ID' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'datum' => 1, 'wijze' => 2, 'aandachtspunten' => 3, 'persoon_id' => 4, 'gebruiker_id' => 5, 'organisatie_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ContactPeer::DATUM);
			$criteria->addSelectColumn(ContactPeer::WIJZE);
			$criteria->addSelectColumn(ContactPeer::AANDACHTSPUNTEN);
			$criteria->addSelectColumn(ContactPeer::PERSOON_ID);
			$criteria->addSelectColumn(ContactPeer::GEBRUIKER_ID);
			$criteria->addSelectColumn(ContactPeer::ORGANISATIE_ID);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.DATUM');
			$criteria->addSelectColumn($alias . '.WIJZE');
			$criteria->addSelectColumn($alias . '.AANDACHTSPUNTEN');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ContactPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ContactPeer::NUM_COLUMNS;
		} else {
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinPersoon(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ContactPeer::PERSOON_ID, PersoonPeer::ID, $join_behavior);
	...
	public static function doCountJoinGebruiker(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ContactPeer::GEBRUIKER_ID, GebruikerPeer::ID, $join_behavior);
	...
	public static function doCountJoinOrganisatie(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ContactPeer::ORGANISATIE_ID, OrganisatiePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Contact objects pre-filled with their Persoon objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPersoon(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = PersoonPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = PersoonPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					PersoonPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Contact) to $obj2 (Persoon)
	...
	/**
	 * Selects a collection of Contact objects pre-filled with their Gebruiker objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Contact objects.
	...
	public static function doSelectJoinGebruiker(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Contact) to $obj2 (Gebruiker)
				$obj2->addContact($obj1);
	...
	/**
	 * Selects a collection of Contact objects pre-filled with their Organisatie objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Contact objects.
	...
	public static function doSelectJoinOrganisatie(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Contact) to $obj2 (Organisatie)
				$obj2->addContact($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		PersoonPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (PersoonPeer::NUM_COLUMNS - PersoonPeer::NUM_LAZY_LOAD_COLUMNS);

		GebruikerPeer::addSelectColumns($criteria);
		$startcol4 = $startcol3 + (GebruikerPeer::NUM_COLUMNS - GebruikerPeer::NUM_LAZY_LOAD_COLUMNS);

		OrganisatiePeer::addSelectColumns($criteria);
		$startcol5 = $startcol4 + (OrganisatiePeer::NUM_COLUMNS - OrganisatiePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = PersoonPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = PersoonPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Contact) to the collection in $obj2 (Persoon)
				$obj2->addContact($obj1);
			} // if joined row not null

			// Add objects for joined Gebruiker rows

			$key3 = GebruikerPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = GebruikerPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					GebruikerPeer::addInstanceToPool($obj3, $key3);
				} // if obj3 loaded

				// Add the $obj1 (Contact) to the collection in $obj3 (Gebruiker)
				$obj3->addContact($obj1);
			} // if joined row not null

			// Add objects for joined Organisatie rows

			$key4 = OrganisatiePeer::getPrimaryKeyHashFromRow($row, $startcol4);
			if ($key4 !== null) {
				$obj4 = OrganisatiePeer::getInstanceFromPool($key4);
				if (!$obj4) {
					...
					OrganisatiePeer::addInstanceToPool($obj4, $key4);
				} // if obj4 loaded

				// Add the $obj1 (Contact) to the collection in $obj4 (Organisatie)
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptPersoon(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Contact objects pre-filled with all related objects except Persoon.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptPersoon(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ContactPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Contact) to the collection in $obj2 (Gebruiker)
				$obj2->addContact($obj1);
				...
				// Add the $obj1 (Contact) to the collection in $obj3 (Organisatie)
				$obj3->addContact($obj1);
	...
	/**
	 * Selects a collection of Contact objects pre-filled with all related objects except Gebruiker.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Contact objects pre-filled with all related objects except Organisatie.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doValidate(Contact $obj, $cols = null)
	{
		...
		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::DATUM))
			$columns[ContactPeer::DATUM] = $obj->getDatum();

		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::WIJZE))
			$columns[ContactPeer::WIJZE] = $obj->getWijze();

		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::AANDACHTSPUNTEN))
			$columns[ContactPeer::AANDACHTSPUNTEN] = $obj->getAandachtspunten();

		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::PERSOON_ID))
			$columns[ContactPeer::PERSOON_ID] = $obj->getPersoonId();

		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::GEBRUIKER_ID))
			$columns[ContactPeer::GEBRUIKER_ID] = $obj->getGebruikerId();

		if ($obj->isNew() || $obj->isColumnModified(ContactPeer::ORGANISATIE_ID))
			$columns[ContactPeer::ORGANISATIE_ID] = $obj->getOrganisatieId();
